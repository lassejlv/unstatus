...
These Terms of Service ("Terms") govern your access to and use of Unstatus ("Service"), operated at [unstatus.app](https://unstatus.app). By creating an account or using the Service, you agree to these Terms.
...
Unstatus is an uptime monitoring and status page platform. It lets you monitor the availability of websites and services, publish public status pages, manage incidents and maintenance windows, and notify subscribers when things change.
...
Unstatus supports multi-user organizations with role-based access (owner, admin, member). The organization owner is responsible for managing membership, permissions, and billing. Invitations are sent via email and expire if not accepted.

## 4. Acceptable Use

You agree not to:

- Use the Service to monitor targets you do not own or have permission to monitor.
...
## 6. Status Pages and Custom Domains

You may publish public status pages under your organization. If you use a custom domain, you are responsible for DNS configuration and domain ownership. We provide SSL certificates automatically via our infrastructure.
...
- Unstatus is provided **"as is"** and **"as available"** without warranties of any kind, express or implied.
